; paging.asm - Higher Half Kernel/Paging setup
; created 2023-03-07 @ ChatGPT
...
.loop_higher_half:
	...
	mov eax, 0x100000   ; map physical address 0x1000000 to virtual address 0x100000
	mov ebx, 0x1000
.loop_map_above_1mb:
	mov dword [page_table + ebx], eax
	or dword [page_table + ebx], 3   ; set present bit and read/write bit
